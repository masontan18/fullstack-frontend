...
{#if $isLogin}
	<div class="flex justify-between items-center nav-container fixed top-0 left-0 right-0">
		<a class="flex-none flex btn btn-outline btn-accent btn-lg nav-title" href="/">
			...
			<div class="flex-none">Next Academy Bootcamp Project</div>
			<div class="flex-none small-title">P2P ECOMM FULL-STACK</div>
		</a>
		...
		<div class="flex-none pr-6 right-container">
			...
			<a class="btn btn-outline btn-accent flex-none" href="/manage/img-m">Manage</a>
			<div class="flex flex-row items-center">
				<a href="/manage/user-m"><img alt="user-logo" src={User} class="user-logo" /> </a>
				<a class="btn btn-outline btn-accent flex-none" href="/users/signIn" on:click={logoutDone}
					>Log Out</a
				>
			</div>
		</div>
...
{:else}
	<div class="flex justify-between items-center nav-container fixed top-0 left-0 right-0">
		...
		<div class="flex-none pr-6">
			...
			<a class="btn btn-outline btn-accent flex-none" href="/users/signUp">List anything yourself</a>
			<a class="btn btn-outline btn-accent flex-none" href="/users/signIn">Log In</a>
		</div>
	</div>
{/if}
